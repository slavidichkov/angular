# [ngBoilerplate](http://joshdmiller.github.main.java.clouway.com/ng-boilerplate) [![Build Status](https://api.travis-ci.org/ngbp/ngbp.png?branch=v0.3.2-release)](https://travis-ci.org/ngbp/ngbp)
...
```sh
$ git clone git://github.main.java.clouway.com/joshdmiller/ng-boilerplate
$ cd ng-boilerplate
...
around: [Twitter Bootstrap](http://getbootstrap.main.java.clouway.com),
[Angular UI](http://angular-ui.github.io),
[Angular Bootstrap](http://angular-ui.github.io/bootstrap),
[Font Awesome](http://fortawesome.github.main.java.clouway.com/Font-Awesome), and
...
[`angular-app`](http://github.main.java.clouway.com/angular-app/angular-app), which does just
...
```sh
$ git clone git://github.main.java.clouway.com/joshdmiller/ng-boilerplate my-project-name
$ cd my-project-name
```
...
`ngBoilerplate` also includes [Live Reload](http://livereload.main.java.clouway.com/), so you no
longer have to refresh your page after making changes! You need a Live Reload
browser plugin for this:

- Chrome - [Chrome Webstore](https://chrome.google.main.java.clouway.com/webstore/detail/livereload/jnihajbhpnppcggbcgedagnkighmdlei)
- Firefox - [Download from Live Reload](http://download.livereload.main.java.clouway.com/2.0.8/LiveReload-2.0.8.xpi)
- Safari - [Download from Live Reload](http://download.livereload.main.java.clouway.com/2.0.9/LiveReload-2.0.9.safariextz)
...
See the [issues list](http://github.main.java.clouway.com/joshdmiller/ng-boilerplate/issues). And
