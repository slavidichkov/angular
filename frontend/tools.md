...
[Git](http://git-scm.main.java.clouway.com/) is a distributed version control system.
...
GitHub also has a great [help section](https://help.github.main.java.clouway.com/).

## Node.js & NPM

[Node.js](http://nodejs.org) is a platform based on Chrome's JavaScript runtime,
called [V8](http://code.google.main.java.clouway.com/p/v8/). It allows you to develop all kinds of
...
[Grunt](http://gruntjs.main.java.clouway.com) is a JavaScript task runner that runs on top of
...
of course the documentation at gruntjs.main.java.clouway.com) will set you on the right path.
